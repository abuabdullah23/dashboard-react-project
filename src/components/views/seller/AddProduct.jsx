                    ...
                    <form onSubmit={handleAddProductForm}>
                        ...
                        <div className='flex flex-col md:flex-row gap-4 w-full mb-4'>
                            ...
                            <div className='flex flex-col w-full gap-1'>
                                ...
                                <input className='px-4 py-2 border border-slate-700 focus:border-indigo-500 outline-none bg-[#283046] rounded-md text-[#d0d2d6]' name='price' type="number" min={0} placeholder='%discount%' />
                            </div>
                        </div>
                        ...
                        <div className='flex flex-col md:flex-row gap-4 w-full mb-4'>
                            <div className='flex flex-col w-full gap-1'>
                                ...
                                <textarea className='px-4 py-2 border border-slate-700 focus:border-indigo-500 outline-none bg-[#283046] rounded-md text-[#d0d2d6]' name='price' type="text" min={0} placeholder='Description' />
                            </div>
                        </div>
