                        ...
                        <tbody className='text-sm font-normal'>
                            {
                                [1, 2, 3, 4, 5].map((item, i) => <tr key={i}>
                                    ...
                                    <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'><span>active</span></td>
                                    <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'><span>Rajshahi</span></td>
                                    <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'><span>Pabna</span></td>
