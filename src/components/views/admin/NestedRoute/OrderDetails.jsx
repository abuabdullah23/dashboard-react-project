            ...
            <div className='w-full p-4 bg-[#283046] rounded-md'>
                ...
                <div className='p-4'>
                    ...
                    <div className='flex flex-wrap'>
                        <div className='w-[32%]'>
                            <div className='pr-3 text-[#d0d2d6]'>
                                <div className='flex flex-col gap-1'>
                                    ...
                                    <p><span className='text-sm'>Rangpur, Kurigram, nageshawri, house no #434</span></p>
                                </div>
                        ...
                        <div className='w-[68%] bg-slate-800 rounded-md'>
                            <div className='pl-3'>
                                <div className='mt-4 flex flex-col gap-6 text-[#d0d2d6]'>
                                    <div>
                                        <div className='flex justify-start items-center gap-3'>
